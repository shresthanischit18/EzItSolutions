          ...
          <div>
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="flex flex-col justify-center text-center lg:text-left order-2 lg:order-1 relative z-10 ml-0 lg:ml-[100px]">
                <h1
                  className="text-[30px] lg:text-[70px] font-semibold text-white"
                  data-aos="fade-up"
                >
                  Exclusive Deals on{" "}
                </h1>
                <h1
                  className="text-[30px] lg:text-[70px] font-semibold text-white lg:w-[700px]"
                  data-aos="fade-up"
                >
                  Electronic Accessories
                </h1>
                <p
                  className="text-[15px] my-5 lg:p-0 text-gray-500"
                  data-aos="fade-up"
                >
                ...
                <div>
                  <button
                    className="bg-[#0E59F2] text-lg border-0 rounded-3xl py-3 px-12 text-white"
                    data-aos="fade-up"
                  >
                    Find Solution
                  </button>
              ...
              {/*Image Section */}
              <div className="order-2 lg:order-2" data-aos="flip-right">
                <img
                  src={banner}
                  alt=""
